"""FFmpeg command construction and per-file conversion execution logic."""
...
from media import MediaInfo, calculate_output_dimensions
...
from tracks import is_text_subtitle
